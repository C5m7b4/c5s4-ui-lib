...
const Configurator = <T,>({
  ...
  return (
    <div
      ...
      data-[display=collapsed]:animate-slideOutRightConfigurator data-[display=expanded]:animate-slideInFromRightConfigurator"
    >
      <div className="flex gap-4">
        ...
        >
          <DoubleChevronRight
            height={10}
            width={10}
            className="cursor-pointer group-data-[display=collapsed]:rotate-180 transition-all duration-300 fill-content"
          />
        </div>
