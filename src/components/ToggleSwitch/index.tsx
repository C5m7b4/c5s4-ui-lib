...
const ToggleSwitch = ({ handleClick, active }: ToggleSwitchProps) => {
  return (
    <div className="relative flex justify-between items-center group p-2 text-xl">
      <input
        type="checkbox"
        className="absolute left-1/2 -translate-x-1/2 w-full h-full peer appearance-none rounded-md"
      />
      <span
        className="w-16 h-10 flex items-center flex-shrink-0 ml-4 p-1  
